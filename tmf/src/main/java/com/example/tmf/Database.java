...
public class Database implements Serializable{
    ...
    Long[] ddd = {100L, 200L};
    long[] eee = {100, 200};
    Float[] fff = {100.99f, 200.99f};
    float[] ggg = {100.99f, 200.99f};
    Double[] hhh = {100.99, 200.99};
    double[] iii = {100.99, 200.99};
    Character[] jjj = {'9', '0'};
    char[] kkk = {'9', '0'};
    Boolean[] lll = {true, true};
    boolean[] mmm = {true, true};

    //====================================================================================
    // ID(PrimaryKey)での検索WHERE句作成
    //====================================================================================
    public void setWherePk(String[] ids) throws TmfException,Exception{
        ...
        // placeHolderの追加
        String dataType = FetchData.class.getField(DatabaseDefine.pkName[0]).getType().getSimpleName();
        ...
        for(int i = 1; i < ids.length; i++) {
            // placeHolderの追加
            dataType = FetchData.class.getField(DatabaseDefine.pkName[i]).getType().getSimpleName();
    ...
    // filterでの検索WHERE句作成
    //====================================================================================
    public void setWhereFilter(String filter) throws TmfException,Exception{  
        ...
        for(int i = 0; i < ors.length; i++){
            ...
            for(int j = 0; j < or.length; j++){
                ...
                String dataType = FetchData.class.getField(attr).getType().getSimpleName();
    ...
    // OREDER BY句の作成
    //====================================================================================
    public void setOrderbySql(String sort) throws TmfException,Exception{
    ...
    // SELECT句の作成
    //====================================================================================
    public void setSelectSql(String fields) throws TmfException,Exception{
    ...
    // データフェッチ
    //====================================================================================
    public ResData fetchDBData(Connection connection, String requestUrl) throws TmfException,Exception{
    ...
    // 列名のチェック
    //====================================================================================
    private void checkAttributeName(String attribute) throws TmfException,Exception{

        try{
            // DBの列名をチェック
            FetchData.class.getField(attribute);
        }
        catch(Exception ex){
            // 不適切なfilter属性指定のエラー処理
