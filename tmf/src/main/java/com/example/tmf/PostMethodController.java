...
public class PostMethodController{
    ...
    // POST method
    //====================================================================================
    public ResponseEntity<ResData.ResBody> postHandler(PoolDataSource poolDataSource, HashMap<String, String> bodyAttribute, String[] ids, String id, String requestUrl, String txId,
    RedisTemplate<String, Redolog> redologRedisTemplate, StringRedisTemplate lockStringRedisTemplate, String twoPhaseCommitMethod)  throws TmfException, Exception{
        ...
        try{
            ...
            // INSERT SQL文の作成
            resBody = database.setUpdateInsertSql(bodyAttribute, ids, requestUrl, "POST");
            ...
            if(StringUtils.hasLength(txId)){
                ...
                // 更新前 Database 設定
                redolog.setBeforeUpdate(connection, ids, "DELETE");
            }
