...
public class Redolog implements Serializable{
    ...
    // 更新前 Database 設定(エラー)
    //=========================================================
    public void setBeforeUpdate(Connection connection, String[] ids, String modifyType) throws TmfException, Exception{
        ...
        try{
            if(modifyType.equals("PUT") || modifyType.equals("POST")){
                ...
                // SELECT句の作成
                database.setSelectSql("");

                // データをフェッチ
                resData = database.fetchDBData(connection, "");
    ...
    public HashMap<String, String> getHashmapAttribute(ResData.ResBody resBody) throws TmfException, Exception{
        ...
        try{
            for(Field field : ResData.ResBody.class.getFields()){
