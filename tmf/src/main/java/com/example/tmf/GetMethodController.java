...
public class GetMethodController{
    ...
    // GET method
    //====================================================================================
    public ResponseEntity<List<ResData.ResBody>> getHandler(String databaseProduct, PoolDataSource poolDataSource, String offset, String limit, String fields, String sort, String filter, String[] ids, String requestUrl, String requestFullPath)  throws TmfException, Exception{
        ...
        try{
            ...
            // filterでの検索WHERE句設定
            database.setWhereFilter(filter);

            // SELECT句の作成
            database.setSelectSql(fields);
            ...
            // ORDER BY句の作成
            database.setOrderbySql(sort);

            // DB接続
            connection = database.connectDB(poolDataSource);

            // データをフェッチ
            resData = database.fetchDBData(connection, requestUrl);
