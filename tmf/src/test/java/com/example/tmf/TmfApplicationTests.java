...
class TmfApplicationTests {
	...
	void contextLoads() throws Exception {
		...
		Console.println(subClass.GetA());
		Console.println(subClass.GetB());
		Console.println(subClass.GetC());
		Console.println(subClass.GetD());
		Console.println(subClass.GetE());
